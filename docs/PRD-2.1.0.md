...
**Phase 1**：核心重构 + markitdown 集成 + 新文本层检测 + 输出标准化  
**Phase 2**：插件运行时架构（捆绑 Python + uv 子进程） + docling 和 opendataloader-pdf 适配器  
**Phase 3**：设置 UI、安装流程、卸载、Java 检测、离线模型指引  
**Phase 4**：全面测试、许可证审查、性能调优、文档

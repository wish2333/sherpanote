...
class ModelEntry:
    ...
    hf_files: tuple[str, ...] | None = None  # Individual files to download from HF repo (multi-file mode)
...
MODELS: tuple[ModelEntry, ...] = (
    ...
    ModelEntry(
        ...
        description="Qwen3 ASR model with multilingual support (zh/en/ja/ko). Supports simulated streaming via VAD.",
    ...
    ModelEntry(
        ...
        description="Qwen3 ASR model from ModelScope. Multilingual support (zh/en/ja/ko). Supports simulated streaming via VAD.",
        required_files=("conv_frontend.onnx", "encoder.int8.onnx", "decoder.int8.onnx"),
        sources=("modelscope",),
    ...
    ModelEntry(
        ...
        description="Qwen3 ASR 1.7B model from ModelScope. Multilingual support (zh/en/ja/ko). Supports simulated streaming via VAD.",
        required_files=("conv_frontend.onnx", "encoder.int8.onnx", "decoder.int8.onnx"),
        sources=("modelscope",),
    ...
    ModelEntry(
        ...
        display_name="SenseVoice Multilingual Int8",
        model_type="offline",
        languages=("zh", "en", "ja", "ko", "yue"),
        size_mb=280,
        archive_name="sherpa-onnx-sense-voice-zh-en-ja-ko-yue-int8-2025-09-09.tar.bz2",
    ...
    # -- Whisper models (HuggingFace only, with full weights) --
    ModelEntry(
        model_id="sherpa-onnx-whisper-distil-large-v3-int8",
        display_name="Whisper Distil Large v3 Int8",
        model_type="offline",
        languages=("zh", "en", "ja", "ko", "de", "fr", "es", "it", "pt", "ru"),
        size_mb=985,
        archive_name="",
        description="Distilled Whisper Large v3 int8 quantized. Self-contained, no external weights needed. ~1 GB.",
        required_files=("tokens.txt", "encoder.int8.onnx", "decoder.int8.onnx"),
        sources=("huggingface", "hf_mirror"),
        hf_repo_id="csukuangfj/sherpa-onnx-whisper-distil-large-v3",
        hf_files=(
    ...
    ModelEntry(
        ...
        display_name="Whisper Distil Large v3 (Full)",
        model_type="offline",
        languages=("zh", "en", "ja", "ko", "de", "fr", "es", "it", "pt", "ru"),
        size_mb=3086,
        archive_name="",
        description="Distilled Whisper Large v3 full precision with external weights. Higher accuracy than int8. ~3 GB.",
        required_files=("tokens.txt", "encoder.onnx", "encoder.weights", "decoder.onnx", "decoder.weights"),
        sources=("huggingface", "hf_mirror"),
        hf_repo_id="csukuangfj/sherpa-onnx-whisper-distil-large-v3",
        hf_files=(
            "distil-large-v3-tokens.txt",
            "distil-large-v3-encoder.onnx",
            "distil-large-v3-encoder.weights",
            "distil-large-v3-decoder.onnx",
            "distil-large-v3-decoder.weights",
        ),
    ),
    ModelEntry(
        model_id="sherpa-onnx-whisper-distil-large-v3.5-int8",
        display_name="Whisper Distil Large v3.5 Int8",
        model_type="offline",
        languages=("zh", "en", "ja", "ko", "de", "fr", "es", "it", "pt", "ru"),
        size_mb=985,
        archive_name="",
        description="Distilled Whisper Large v3.5 int8 quantized. Self-contained, no external weights needed. ~1 GB.",
        required_files=("tokens.txt", "encoder.int8.onnx", "decoder.int8.onnx"),
        sources=("huggingface", "hf_mirror"),
        hf_repo_id="csukuangfj/sherpa-onnx-whisper-distil-large-v3.5",
        hf_files=(
    ...
    ModelEntry(
        ...
        display_name="Whisper Distil Large v3.5 (Full)",
        model_type="offline",
        languages=("zh", "en", "ja", "ko", "de", "fr", "es", "it", "pt", "ru"),
        size_mb=3086,
        archive_name="",
        description="Distilled Whisper Large v3.5 full precision with external weights. Highest accuracy variant. ~3 GB.",
        required_files=("tokens.txt", "encoder.onnx", "encoder.weights", "decoder.onnx", "decoder.weights"),
        sources=("huggingface", "hf_mirror"),
        hf_repo_id="csukuangfj/sherpa-onnx-whisper-distil-large-v3.5",
        hf_files=(
            "distil-large-v3.5-tokens.txt",
            "distil-large-v3.5-encoder.onnx",
            "distil-large-v3.5-encoder.weights",
            "distil-large-v3.5-decoder.onnx",
            "distil-large-v3.5-decoder.weights",
        ),
    ),
    ModelEntry(
        model_id="sherpa-onnx-whisper-turbo-int8",
        display_name="Whisper Turbo Int8",
        model_type="offline",
        languages=("zh", "en", "ja", "ko", "de", "fr", "es", "it", "pt", "ru"),
        size_mb=1037,
        archive_name="",
        description="Whisper Turbo int8 quantized. Fast with good accuracy. Self-contained. ~1 GB.",
        required_files=("tokens.txt", "encoder.int8.onnx", "decoder.int8.onnx"),
        sources=("huggingface", "hf_mirror"),
        hf_repo_id="csukuangfj/sherpa-onnx-whisper-turbo",
        hf_files=(
            "turbo-tokens.txt",
    ...
    ModelEntry(
        ...
        display_name="Whisper Turbo (Full)",
        model_type="offline",
        languages=("zh", "en", "ja", "ko", "de", "fr", "es", "it", "pt", "ru"),
        size_mb=3237,
        archive_name="",
        description="Whisper Turbo full precision. Encoder uses external weights, decoder is self-contained. May have issues, test before use. ~3.2 GB.",
        required_files=("tokens.txt", "encoder.onnx", "encoder.weights", "decoder.onnx"),
        sources=("huggingface", "hf_mirror"),
        hf_repo_id="csukuangfj/sherpa-onnx-whisper-turbo",
        hf_files=(
            "turbo-tokens.txt",
    ...
    ModelEntry(
        model_id="sherpa-onnx-whisper-medium-int8",
        display_name="Whisper Medium Int8",
        model_type="offline",
        languages=("zh", "en", "ja", "ko", "de", "fr", "es", "it", "pt", "ru"),
        size_mb=946,
        archive_name="",
        description="Whisper Medium int8 quantized. Good balance of size and accuracy. Self-contained. ~1 GB.",
        required_files=("tokens.txt", "encoder.int8.onnx", "decoder.int8.onnx"),
        sources=("huggingface", "hf_mirror"),
        hf_repo_id="csukuangfj/sherpa-onnx-whisper-medium",
        hf_files=(
            "medium-tokens.txt",
    ...
    ModelEntry(
        model_id="sherpa-onnx-whisper-medium",
        display_name="Whisper Medium (Full)",
        model_type="offline",
        languages=("zh", "en", "ja", "ko", "de", "fr", "es", "it", "pt", "ru"),
        size_mb=1632,
        archive_name="",
        description="Whisper Medium full precision. Good multilingual accuracy in a moderate size. ~1.6 GB.",
    ...
    ModelEntry(
        ...
        description="Voice Activity Detection v4. Legacy model.",
    ...
    ModelEntry(
        ...
        languages=(),
        size_mb=2,
        archive_name="silero_vad_v5.onnx",
        description="Voice Activity Detection v5. Improved accuracy. Recommended.",
        required_files=("silero_vad_v5.onnx",),
        sources=("github", "huggingface", "hf_mirror", "modelscope"),
        hf_repo_id="csukuangfj/vad",
    ),

...
MODELS: tuple[ModelEntry, ...] = (
    ...
    # -- whisper.cpp GGML models (optional plugin) --
    ModelEntry(
        model_id="whisper-ggml-tiny",
        display_name="Whisper Tiny (GGML / whisper.cpp)",
        model_type="whispercpp",
        languages=("en", "zh", "ja", "ko", "de", "fr", "es", "it", "pt", "ru"),
        size_mb=75,
        archive_name="ggml-tiny.bin",
        description="Whisper tiny model for whisper.cpp. Fastest, lowest accuracy. Good for testing.",
        required_files=("ggml-tiny.bin",),
        sources=("huggingface", "hf_mirror"),
        hf_repo_id="ggerganov/whisper.cpp",
    ),
    ModelEntry(
        model_id="whisper-ggml-base",
        display_name="Whisper Base (GGML / whisper.cpp)",
        model_type="whispercpp",
        languages=("en", "zh", "ja", "ko", "de", "fr", "es", "it", "pt", "ru"),
        size_mb=148,
        archive_name="ggml-base.bin",
        description="Whisper base model for whisper.cpp. Good balance of speed and accuracy.",
        required_files=("ggml-base.bin",),
        sources=("huggingface", "hf_mirror"),
        hf_repo_id="ggerganov/whisper.cpp",
    ),
    ModelEntry(
        model_id="whisper-ggml-small",
        display_name="Whisper Small (GGML / whisper.cpp)",
        model_type="whispercpp",
        languages=("en", "zh", "ja", "ko", "de", "fr", "es", "it", "pt", "ru"),
        size_mb=492,
        archive_name="ggml-small.bin",
        description="Whisper small model for whisper.cpp. Better accuracy, slower.",
        required_files=("ggml-small.bin",),
        sources=("huggingface", "hf_mirror"),
        hf_repo_id="ggerganov/whisper.cpp",
    ),
    ModelEntry(
        model_id="whisper-ggml-medium",
        display_name="Whisper Medium (GGML / whisper.cpp)",
        model_type="whispercpp",
        languages=("en", "zh", "ja", "ko", "de", "fr", "es", "it", "pt", "ru"),
        size_mb=1542,
        archive_name="ggml-medium.bin",
        description="Whisper medium model for whisper.cpp. High accuracy, requires more memory.",
        required_files=("ggml-medium.bin",),
        sources=("huggingface", "hf_mirror"),
        hf_repo_id="ggerganov/whisper.cpp",
    ),
    ModelEntry(
        model_id="whisper-ggml-large-v3",
        display_name="Whisper Large v3 (GGML / whisper.cpp)",
        model_type="whispercpp",
        languages=("en", "zh", "ja", "ko", "de", "fr", "es", "it", "pt", "ru"),
        size_mb=3101,
        archive_name="ggml-large-v3.bin",
        description="Whisper large v3 model for whisper.cpp. Best accuracy, slowest. Requires GPU for practical use.",
        required_files=("ggml-large-v3.bin",),
        sources=("huggingface", "hf_mirror"),
        hf_repo_id="ggerganov/whisper.cpp",
    ),
)

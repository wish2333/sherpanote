...
MODELS: tuple[ModelEntry, ...] = (
    ...
    ModelEntry(
        model_id="sherpa-onnx-whisper-large-v3",
        display_name="Whisper Large v3",
        model_type="offline",
        languages=("zh", "en", "ja", "ko", "de", "fr", "es", "it", "pt", "ru"),
        size_mb=1020,
        archive_name="sherpa-onnx-whisper-large-v3.tar.bz2",
        description="Whisper Large v3 with high multilingual accuracy. Larger but more capable than distilled variants.",
        required_files=("tokens.txt", "encoder.onnx", "decoder.onnx"),
        sources=("github", "huggingface", "hf_mirror", "ghproxy"),
    ),
    ModelEntry(
        model_id="sherpa-onnx-whisper-large-v2",
        display_name="Whisper Large v2",
        model_type="offline",
        languages=("zh", "en", "ja", "ko", "de", "fr", "es", "it", "pt", "ru"),
        size_mb=1060,
        archive_name="sherpa-onnx-whisper-large-v2.tar.bz2",
        description="Whisper Large v2 with strong multilingual accuracy. Proven and widely used.",
        required_files=("tokens.txt", "encoder.onnx", "decoder.onnx"),
        sources=("github", "huggingface", "hf_mirror", "ghproxy"),
    ),
    ModelEntry(
